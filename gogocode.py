...
#     server.login('211293@juitsolan.in', 'isha@2812')
#     server.sendmail('211293@juitsolan.in', to, content)
#     server.close()
...
class MainThread(QThread):
    ...
    def TaskExecution(self):
        ...
        while True:
            ...
            # elif 'email to prachi' in self.query:
            #     try:
            #         speak("What should I say?")
            #         content = takeCommand()
            #         to = "211288@juitsolan.in"  
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("..\..\Desktop\gogo\gif3.gif")
